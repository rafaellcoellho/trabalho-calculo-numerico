...
TEST(lagrange, intervalo_positivo_de_raizes) {
    ...
    teorema_de_lagrange(polinomio, grau, intervalo_positivo, intervalo_negativo);
...
TEST(lagrange, teorema_de_bolzano_intervalo_com_raiz) {
    ...
    CHECK_EQUAL(0 ,teorema_de_bolzano(polinomio, grau, intervalo));
}
...
TEST(lagrange, teorema_de_bolzano_intervalo_sem_raiz) {
    ...
    CHECK_EQUAL(1 ,teorema_de_bolzano(polinomio, grau, intervalo));
}
...
TEST(lagrange, raiz_aproximada_metodo_bissecao) {
    ...
    double raiz_aproximada = metodo_da_bissecao(polinomio, grau, intervalo);
